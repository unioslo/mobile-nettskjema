...
public class InplaceFileTransformation {
    ...
    public InplaceFileTransformation(File originalFile, Pipe<File, File> transformingPipe) {
        this.originalFile = originalFile;
        this.transformingPipe = transformingPipe;
    }

    public void perform() throws MobileNettskjemaException {
        TemporaryFile tempFile = new TemporaryFile(originalFile);
        transformingPipe.connect(originalFile, tempFile.file());
        tempFile.replaceOriginalFile();
    }
}
