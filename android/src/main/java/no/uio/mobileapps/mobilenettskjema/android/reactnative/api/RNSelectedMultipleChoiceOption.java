...
public class RNSelectedMultipleChoiceOption implements RNApiField<SelectedMultiOption> {
    ...
    public RNSelectedMultipleChoiceOption(ReadableMap field) throws MobileNettskjemaException {
    ...
    public SelectedMultiOption field() throws MobileNettskjemaException {
        return new SelectedMultiOption(new MultipleChoiceQuestion(questionId, Collections.singletonList(selectedOptionId)), 0);
    }
}
